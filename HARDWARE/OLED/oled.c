...
void showFloat(u8 x,u8 y,float fnum,u8 size)
{
	u8 i;
	u8 buf[10]={0x00};
	char Buf[10]={0x00};
...
void Display1(void)
{
    ...
    OLED_ShowCHinese(46,0,3);
    OLED_ShowCHinese(62,0,4);
    OLED_ShowCHinese(78,0,5);
    OLED_ShowCHinese(94,0,6);

    OLED_ShowCHinese(0,2,7);
    OLED_ShowString(15,2,"S1",16);
    OLED_ShowCHinese(31,2,12);
    OLED_ShowCHinese(46,2,13);
    OLED_ShowCHinese(62,2,14);
    OLED_ShowCHinese(78,2,15);
    OLED_ShowCHinese(94,2,16);

    OLED_ShowCHinese(0,4,7);
    OLED_ShowString(15,4,"S2",16);
    OLED_ShowCHinese(31,4,12);
    OLED_ShowCHinese(46,4,18);
    OLED_ShowCHinese(62,4,19);
    OLED_ShowCHinese(78,4,15);
    OLED_ShowCHinese(94,4,16);
}

void Display2(void)
{
    OLED_ShowCHinese(0,0,20);
    OLED_ShowCHinese(15,0,21);
    OLED_ShowString(31,0,":",16);
    OLED_ShowCHinese(78,0,24);
    OLED_ShowCHinese(94,0,25);
    OLED_ShowCHinese(110,0,26);

    OLED_ShowCHinese(0,2,7);
    OLED_ShowString(15,2,"S1",16);
    OLED_ShowCHinese(31,2,27);
    OLED_ShowCHinese(46,2,28);
    OLED_ShowCHinese(62,2,7);
    OLED_ShowString(78,2,"S2",16);
    OLED_ShowCHinese(94,2,29);
    OLED_ShowCHinese(110,2,30);

    OLED_ShowCHinese(0,4,7);
    OLED_ShowString(15,4,"S3",16);
    OLED_ShowCHinese(31,4,31);
    OLED_ShowCHinese(46,4,32);

    OLED_ShowCHinese(0,6,7);
    OLED_ShowString(15,6,"S4",16);
    OLED_ShowCHinese(31,6,33);
    OLED_ShowCHinese(46,6,34);
    OLED_ShowCHinese(62,6,35);
    OLED_ShowCHinese(78,6,36);
    OLED_ShowCHinese(94,6,37);
...
void Display3(void)
{
    OLED_ShowString(0,0,"weight:",12);
	  OLED_ShowString(120,0,"g",12);
    OLED_ShowString(0,1,"charge:",12);

    OLED_ShowCHinese(0,2,40);
    OLED_ShowCHinese(15,2,41);
    OLED_ShowCHinese(31,2,42);
    OLED_ShowString(46,2,":",16);

    OLED_ShowCHinese(112,2,24);
    OLED_ShowCHinese(0,4,7);
    OLED_ShowString(15,4,"S3",16);
    OLED_ShowCHinese(31,4,31);
    OLED_ShowCHinese(46,4,32);
...
void Display4(void)
{
    ...
    OLED_ShowCHinese(15,0,60);
    OLED_ShowCHinese(31,0,61);
    OLED_ShowNum(46,0,number,2,16);
    OLED_ShowCHinese(62,0,62);

    OLED_ShowCHinese(0,2,7);
    OLED_ShowString(15,2,"S3",16);
    OLED_ShowCHinese(31,2,47);
    OLED_ShowCHinese(46,2,48);
    OLED_ShowCHinese(62,2,49);
    OLED_ShowCHinese(78,2,50);
    OLED_ShowCHinese(94,2,51);

    OLED_ShowCHinese(0,4,7);
    OLED_ShowString(15,4,"S4",16);
    OLED_ShowCHinese(31,4,52);
    OLED_ShowCHinese(46,4,53);
    OLED_ShowCHinese(62,4,54);
    OLED_ShowCHinese(78,4,55);
...
void Display5(void)
{
    ...
    OLED_ShowCHinese(0,4,7);
    OLED_ShowString(15,4,"S4",16);
    OLED_ShowCHinese(31,4,33);
    OLED_ShowCHinese(46,4,34);
    OLED_ShowCHinese(62,4,56);
    OLED_ShowCHinese(78,4,57);
    OLED_ShowCHinese(94,4,58);
}
...
void Display(int num)
{
    switch(num)
        ...
        case 2:Display2();showFloat(40,1,unit_price,16);break;
